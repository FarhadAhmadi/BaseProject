using BaseProject.Domain.Constants.Security;
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public virtual IEnumerable<DefaultPermissionRecord> GetDefaultPermissions()
        {
            return new[]
            {
                ...
                {
                    UserRoleSystemName = SystemCustomerRoleNames.Administrators,
                ...
                new DefaultPermissionRecord
                {
                    UserRoleSystemName = SystemCustomerRoleNames.Guests,
                    PermissionRecords = new[]
                    {
                        DisplayPrices,
                        EnableShoppingCart,
                ...
                new DefaultPermissionRecord
                {
                    UserRoleSystemName = SystemCustomerRoleNames.Registered,
                    PermissionRecords = new[]
                    {
                        DisplayPrices,
                        EnableShoppingCart,
                ...
                new DefaultPermissionRecord
                {
                    UserRoleSystemName = SystemCustomerRoleNames.Vendors,
                    PermissionRecords = new[]
                    {
                        AccessAdminPanel,
                        ManageProducts,
                ...
                new DefaultPermissionRecord
                {
                    UserRoleSystemName = SystemCustomerRoleNames.Staff,
                    PermissionRecords = new[]
                    {
                        AccessAdminPanel,
                        ManageProducts,
                ...
                new DefaultPermissionRecord
                {
                    UserRoleSystemName = SystemCustomerRoleNames.SalesManager,
                    PermissionRecords = new[]
                    {
                        AccessAdminPanel,
                        ManageOrders,
