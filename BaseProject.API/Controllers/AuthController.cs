...
namespace BaseProject.API.Controllers
{
    public class AuthController(IAuthService authService) : BaseController
    {
        ...
        /// <returns></returns>
        [HttpPost("sign-in")]
        [SwaggerResponse(200, "Successfully signed in.", typeof(UserSignInResponseDto))]
        ...
        [HttpGet("profile")]
        [Authorize]
        [SwaggerResponse(200, "Successfully retrieved user profile.", typeof(UserProfileResponseDto))]
